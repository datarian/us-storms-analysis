...
#grph <- merge(states,humanDamageRecent, by = "state")
...
stateNameFromCode <-function(x) {
    ...
    st.codes<-data.frame(
        state=as.factor(c("AK", "AL", "AR", "AS", "AZ", "CA", "CO", "CT", "DC", "DE", "FL", "GA", "GU",
                          ...
                          "MI", "MH", "MN", "MO", "MS",  "MT", "NC", "ND", "NE", "NH", "NJ", "NM",
        ...
        full=as.factor(c("alaska","alabama","arkansas", "american samoa", "arizona","california","colorado",
                         ...
                         "louisiana","massachusetts","maryland","maine","michigan", "marshall islands", "minnesota",
